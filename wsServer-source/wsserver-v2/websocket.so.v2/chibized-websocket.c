...
/*
types: (connection_struct ws_events)
enums: ()
*/
...
sexp sexp_ws_getaddress_stub (sexp ctx, sexp self, sexp_sint_t n, sexp arg0) {
  sexp res;
  res = sexp_c_string(ctx, ws_getaddress(arg0), -1);
  return res;
}
...
sexp sexp_ws_get_fd_stub (sexp ctx, sexp self, sexp_sint_t n, sexp arg0) {
  ...
  res = sexp_make_integer(ctx, ws_get_fd((struct connection_struct*)sexp_cpointer_value(arg0)));
  return res;
}
...
sexp sexp_ws_close_client_stub (sexp ctx, sexp self, sexp_sint_t n, sexp arg0) {
  sexp res;
  res = sexp_make_integer(ctx, ws_close_client(arg0));
  return res;
}
...
sexp sexp_ws_sendframe_bin_stub (sexp ctx, sexp self, sexp_sint_t n, sexp arg0, sexp arg1, sexp arg2) {
  ...
  if (! sexp_exact_integerp(arg2))
    return sexp_type_exception(ctx, self, SEXP_FIXNUM, arg2);
  res = sexp_make_integer(ctx, ws_sendframe_bin(sexp_sint_value(arg0), sexp_string_data(arg1), sexp_uint_value(arg2)));
  return res;
}
sexp sexp_ws_sendframe_txt_stub (sexp ctx, sexp self, sexp_sint_t n, sexp arg0, sexp arg1) {
  ...
  if (! sexp_stringp(arg1))
    return sexp_type_exception(ctx, self, SEXP_STRING, arg1);
  res = sexp_make_integer(ctx, ws_sendframe_txt(sexp_sint_value(arg0), sexp_string_data(arg1)));
  return res;
}
...
sexp sexp_ws_sendframe_stub (sexp ctx, sexp self, sexp_sint_t n, sexp arg0, sexp arg1, sexp arg2, sexp arg3) {
  ...
  if (! sexp_exact_integerp(arg3))
    return sexp_type_exception(ctx, self, SEXP_FIXNUM, arg3);
  res = sexp_make_integer(ctx, ws_sendframe(arg0, sexp_string_data(arg1), sexp_uint_value(arg2), sexp_sint_value(arg3)));
  return res;
}
...
sexp sexp_init_library (sexp ctx, sexp self, sexp_sint_t n, sexp env, const char* version, const sexp_abi_identifier_t abi) {
  sexp sexp_connection_struct_type_obj;
  ...
  name = sexp_c_string(ctx, "connection_struct", -1);
  sexp_connection_struct_type_obj = sexp_register_c_type(ctx, name, sexp_finalize_c_type);
  tmp = sexp_string_to_symbol(ctx, name);
  sexp_env_define(ctx, env, tmp, sexp_connection_struct_type_obj);
